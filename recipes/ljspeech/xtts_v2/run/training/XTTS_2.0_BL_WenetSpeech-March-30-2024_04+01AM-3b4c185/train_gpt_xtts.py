...
DATASETS_CONFIG_LIST = [config_dataset_en]
...
def main():
    ...
    checkpoint_path = '/workspace/TTS/recipes/ljspeech/xtts_v2/run/training/XTTS_2.0_BL_WenetSpeech-January-25-2024_01+33AM-0000000/best_model_346725.pth'
